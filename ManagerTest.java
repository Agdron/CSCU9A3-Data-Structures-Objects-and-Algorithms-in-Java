...
public class ManagerTest {
	...
	public void loadData() {
		...
		Customer[] customer_list = new Customer[]{ new Customer("John J", 147, "jj@multi.ac.uk", 999999, "Apple"),
		...
		//Ahhh Squiggly red lines, my old enemy
...
/*		assertEquals("Incorrect Walk","Xing L , Alma A , Zeus L , Borba B ,  ", manager.walkTree(0));
		System.out.println("\n-- Walk Tree --\n" + manager.walkTree(0));*/
	}
